...
const Progress = (() => {
  ...
  const ACHIEVEMENTS = [
    ...
    { id: 'score_1000',     label: 'Thousand Club',      desc: 'Score 1,000 points in one game',                     check: (d) => d.bestScore >= 1000 },
    { id: 'score_10k',      label: 'Rising Star',        desc: 'Score 10,000 points in one game',                    check: (d) => d.bestScore >= 10_000 },
    { id: 'score_100k',     label: 'Hundred Grand',      desc: 'Score 100,000 points in one game',                   check: (d) => d.bestScore >= 100_000 },
    { id: 'score_1m',       label: 'Millionaire',        desc: 'Score 1,000,000 points in one game',                 check: (d) => d.bestScore >= 1_000_000 },
    { id: 'score_100m',     label: 'Big Shot',           desc: 'Score 100,000,000 points in one game',               check: (d) => d.bestScore >= 100_000_000 },
    { id: 'score_1b',       label: 'Billionaire',        desc: 'Score 1,000,000,000 points in one game',             check: (d) => d.bestScore >= 1_000_000_000 },
    { id: 'score_100b',     label: 'Eleven Zeros',       desc: 'Score 100,000,000,000 points in one game',           check: (d) => d.bestScore >= 100_000_000_000 },
    { id: 'score_1q',       label: 'Quadrillionaire',    desc: 'Score 1,000,000,000,000,000 points in one game',     check: (d) => d.bestScore >= 1e15 },
    { id: 'score_1sx',      label: 'To The Moon',        desc: 'Score 1,000,000,000,000,000,000,000 points in one game', check: (d) => d.bestScore >= 1e21 },
