...
const I18n = (() => {
  const STRINGS = {
    en: {
      ...
      helpVoiceNumber:  'Say your <strong>trigger word</strong> then the answer — e.g. <strong>"fire 48"</strong> or <strong>"fire forty-eight"</strong>',
      helpVoiceTrigger: 'A bare number (without the trigger word) shows a preview but does <em>not</em> submit — change the word above to anything you like (default: fire)',
      ...
      voiceTriggerNote: 'Say this word before your answer (e.g. "fire 48")',
    ...
    de: {
      ...
      helpVoiceNumber:  '<strong>Stimmbefehl</strong> + Antwort sagen — z.B. <strong>„feuer 48"</strong> oder <strong>„feuer achtundvierzig"</strong>',
      helpVoiceTrigger: 'Eine einzelne Zahl (ohne Stimmbefehl) zeigt nur eine Vorschau — oben ein beliebiges Wort festlegen (Standard: feuer)',
    ...
    es: {
      ...
      helpVoiceNumber:  'Di la <strong>palabra activadora</strong> seguida de la respuesta — p.ej. <strong>"fuego 48"</strong> o <strong>"fuego cuarenta y ocho"</strong>',
      helpVoiceTrigger: 'Un número solo (sin la palabra activadora) muestra una vista previa pero <em>no</em> lo envía — cambia la palabra arriba a lo que quieras (predeterminado: fuego)',
